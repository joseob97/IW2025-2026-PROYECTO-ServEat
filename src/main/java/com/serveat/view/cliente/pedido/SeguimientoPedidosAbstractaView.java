...
public abstract class SeguimientoPedidosAbstractaView extends VerticalLayout {
    ...
    protected final void construirUI(String tituloPantalla, Component accionesTop) {
        setPadding(true);
        setSpacing(false);
        setWidthFull();
        ...
        configurarFiltros();
        configurarGridBase();
        configurarColumnasExtraGrid();

        cargarPagina(0);
    }

    protected abstract Page<Pedido> buscarPagina(String username,
                                                 LocalDateTime desde,
                                                 LocalDateTime hasta,
    ...
    protected abstract void configurarColumnasExtraGrid();
    ...
    protected final void cargarPagina(int newPageIndex) {
        try {
