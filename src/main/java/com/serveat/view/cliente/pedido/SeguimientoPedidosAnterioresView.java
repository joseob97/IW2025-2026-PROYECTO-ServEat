...
public class SeguimientoPedidosAnterioresView extends VerticalLayout {
    ...
    public SeguimientoPedidosAnterioresView(PedidoSeguimientoService seguimientoService) {
        ...
        H3 titulo = new H3("Pedidos anteriores");
    ...
    private void cargarPagina(int newPageIndex) {
        try {
            ...
            Page<Pedido> page = seguimientoService.buscarAnterioresCliente(
                    username,
                    d, h,
