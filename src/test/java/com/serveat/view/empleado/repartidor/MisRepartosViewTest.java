...
class MisRepartosViewTest {
    ...
    @Test
    void vista_se_crea_y_carga_repartos() {
        RepartidorService repartidorService = mock(RepartidorService.class);
        PedidoCalculoService pedidoCalculoService = mock(PedidoCalculoService.class);
        ...
        when(repartidorService.buscarMisRepartos(any(), any(), any(), any(), any()))
                .thenReturn(page);

        MisRepartosView view = new MisRepartosView(
                repartidorService,
        ...
        assertNotNull(findH3(view, "Mis repartos"));
        ...
        verify(repartidorService, atLeastOnce())
                .buscarMisRepartos(any(), any(), any(), any(), any());
    }
